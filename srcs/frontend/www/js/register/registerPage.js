function makeRegisterPage() {
	...
	<div id="welcome-box" style="display: block;">
		<div class="mainpage">
			<div class="welcome-message">
				<div class="login-title">Welcome to Transcendence</div>
				<div class="text-title-box">The final project of the 42 curriculum</div>
			...
			<div class="login-middle-box">
				<div class="" id="registerForm">
					<form class="login-form" id="userRegisterForm">
						...
						<!-- Password input -->
						<label class="font-custom" for="form1Example3">PASSWORD</label>
						<input type="password" class="form-control button-size" id="form1Example3" maxlength="20"
							name="password" placeholder="Password">
						<!-- Confirm Password input -->
						<label class="font-custom" for="form1Example4">CONFIRM PASSWORD</label>
						<input type="password" class="form-control button-size" id="form1Example4" maxlength="20"
