function createNavbar1() {
	return `
	<div class="" id="navBar" data-page="register">
	<div class="">
		<a class="" href="" id="home">Transcendence</a>
		<button class="" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
			<span class=""></span>
		</button>
		<div class="" id="navbarNavDropdown">
			<ul class="">
				<li class="">
					<a class="" aria-current="page" href="" data-i18n="1">make link</a>
				</li>
				<li class="">
					<a class="" href="" id="gameLink" data-i18n="2">make link1</a>
				</li>
				<li class="">
					<a class="" href="" data-i18n="3">make link2</a>
				</li>
			</ul>
			<ul class="">
				<li class="">
					<button id="signIn" type="button" class="btn" data-page="signin">Sign in</button>
				</li>
				<li class="">
					<button id="register" class="btn btn-primary" type="button" data-page="register">CREATE ACCOUNT</button>
				</li>
			</ul>
		</div>
	</div>
