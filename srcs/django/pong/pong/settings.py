...
import os
import logging.config #ver impresso no terminal do Django
...
CORS_ALLOW_METHODS = [
    'GET',
    'POST',
    'PUT',  # Adicione os métodos que você deseja permitir
    'DELETE',
]
...
CORS_ALLOW_HEADERS = [
    'Authorization',
    'Content-Type',
    'X-CSRFToken',  # Adicione os cabeçalhos personalizados que você deseja permitir
    # Adicione mais cabeçalhos personalizados, se necessário
]
